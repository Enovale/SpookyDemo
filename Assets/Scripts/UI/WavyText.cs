...
public class WavyText : MonoBehaviour
{
    ...
    public float DifferenceMultiplier = 0.5f;
    ...
    IEnumerator AnimateGlyphs()
    {
        ...
        while (true)
        {
            ...
            for (var i = 0; i < characterCount; i++)
            {
                ...
                //Debug.Log($"Loops: {loopCount}; Speed: {vertAnim.speed}");
                Vector3 jitterOffset = new Vector3(0, Mathf.PingPong((loopCount / 25f) * SpeedMultiplier + (i * DifferenceMultiplier), SizeMultiplier), 0);
